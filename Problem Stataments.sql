...
Find the movie with the longest runtime or TV show with the most number of episodes.

6. Find Content Added in the Last 5 Years
List the content that has been added to Netflix within the last five years.

7. Find All Movies/TV Shows by Director 'Steven Spielberg'
Extract all movies or TV shows that were directed by Steven Spielberg.

8. List All TV Shows with More Than 5 Seasons
Identify TV shows that have more than 5 seasons.

9. Count the Number of Content Items in Each Genre
Count how many content items belong to each genre.

10. Find the Average Content per Year Produced in Nigeria
Calculate the average content per year that was produced in Nigeria.

11. List All Movies That Are Documentaries
Extract all movies classified as documentaries.

12. Find All Content Without a Director
Find the entries where no director is listed.

13. Find Movies with Descriptions Containing Keywords ('AI', 'Sci-Fi', 'Space')
Search for movies containing the keywords "AI," "Sci-Fi," or "Space" in the description.
